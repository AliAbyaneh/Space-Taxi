...
string Driver::print()
{
	return username + " " + address + " " + spaceship_model + " " + spaceship_color + "\n";
}
...
string Driver::show_trip_requests()
{
	...
	for (int i = 0; i < trips.size(); i++)
		...
		{
			result += trips[i]->print();
			not_requested = false;
		}
	if(not_requested)
		return"Dear " + username + ": at this moment system can not find any trip request for you!\n";
	return result;
}
